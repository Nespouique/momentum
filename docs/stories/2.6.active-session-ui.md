...
### SetInput Component
Utiliser le composant `NumberInput` (créé en 1.5) comme base pour les steppers.
...
// Basé sur NumberInput avec customisation:
// Reps: step=1
// Weight: step=2.5 (ou 5 pour gros incréments)
```
